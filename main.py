...
data1_path = '/home/jxy/xh/project/sl/vis_ir_dataset64.h5'
data2_path = '/home/jxy/xh/project/sl/oe_ue_Y_dataset64.h5'
data3_path = '/home/jxy/xh/project/sl/far_near_Y_dataset64.h5'
...
def main():
	with tf.Graph().as_default(), tf.Session() as sess:
		...
		saver = tf.train.Saver(var_list = model.var_list, max_to_keep = 80)
